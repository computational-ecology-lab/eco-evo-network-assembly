...
This material provides the original df's used in the paper. Istead of running #1 and #2, it is possible to generate plots with the same df's from the main text. By running #1 and #2 with new simulations, new df's will overwrite the old ones
...
5. Run codes. As a simple demo, run: python EcoEvoAnalysis.py
This will quickly create plots for Type 2 scenarios, as shown in figures 1, 3, S1, and S2 (S figures take about 10 minutes to generate)
