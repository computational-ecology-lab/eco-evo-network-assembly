...
#path = dir_path+'/df/analysis_df_1/'+str(filecodes[0][0])+'-df-'+str(filecodes[0][1])+'.pkl'
...
# Read the data.
# We use the table available from the supplementary material of Grilli (2020)
path = 'EcoEvo/metaecoevo/finalModel/grilli_longitudinal_data/proj_time.csv'
df = pd.read_csv(path)
